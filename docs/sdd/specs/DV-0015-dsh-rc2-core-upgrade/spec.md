...
公开 GitHub Release、资产上传与 Apple 公证仍保持独立授权边界。
...
- NG-001：本规格不创建公开 GitHub Release、不上传安装资产，也不执行 Apple 公证、ticket
  staple 或将 0.2.3 标记为 Latest。
...
- 公证配置缺失或未获单独授权时，签名候选包不得被描述为已公证或可公开下载资产。

...
describe('DeepViewer branded loading surfaces (DV-0006)', () => {
  ...
  it('centers the runtime lockup in the viewport instead of the Figma canvas', () => {
    ...
    expect(rendererCss).toContain('width: 150.374px')
    expect(rendererCss).toContain('height: 160px')
  ...
  it('installs an independent Harness loading overlay with a stable logo', () => {
    ...
    expect(HARNESS_LOADING_BRAND_CSS).toContain('width: 150.374px')
    expect(HARNESS_LOADING_BRAND_CSS).toContain('height: 160px')

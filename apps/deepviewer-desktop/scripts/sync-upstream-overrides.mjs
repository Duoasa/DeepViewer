...
const fileOverrides = [
  ...
  {
    name: 'activity-island-publisher',
    sourcePath: resolve(
      appRoot,
      'upstream-overrides',
      'ui-conversation',
      'DeepViewerActivityPublisher.tsx',
    ),
    targetPath: resolve(
      upstreamRoot,
      'packages',
  ...
  {
    name: 'activity-island-settings-component',
    sourcePath: resolve(
      appRoot,
      'upstream-overrides',
      'ui-settings-general',
      'ActivityIslandSection.tsx',
    ),
    targetPath: resolve(
      upstreamRoot,
      'packages',
  ...
  },
  {
    ...
    sourcePath: resolve(
      ...
      'upstream-overrides',
      'ui-settings-general',
      'ActivityIslandSection.module.css',
    ),
    targetPath: resolve(
      upstreamRoot,
      'packages',
...
export type DetailsSlotProps = PropsRuntime<'details'> & PropsRenderSlots<'conversation.details.tool'>
  ...
  {
    name: 'activity-island-publisher-import',
    sourcePath: resolve(
      appRoot,
      'upstream-overrides',
      'ui-conversation',
      'ActivityPublisherImport.tsx.fragment',
    ),
    targetPath: resolve(
      upstreamRoot,
      'packages',
    ...
    needle: "import css from './ConversationRoot.module.css'",
    indent: '',
    markerKind: 'code',
  },
  {
    name: 'activity-island-publisher-seat',
    sourcePath: resolve(
      appRoot,
      'upstream-overrides',
      'ui-conversation',
      'ActivityPublisherSeat.tsx.fragment',
    ),
    targetPath: resolve(
      upstreamRoot,
      'packages',
    ...
    needle: '    <div className={css.root} data-phase={phase}>\n',
    indent: '      ',
    preserveNeedle: true,
  },
  {
    name: 'activity-island-settings-import',
    sourcePath: resolve(
      appRoot,
      'upstream-overrides',
      'ui-settings-general',
      'ActivityIslandImport.tsx.fragment',
    ),
    targetPath: resolve(
      upstreamRoot,
      'packages',
  ...
  {
    name: 'activity-island-settings-registration',
    sourcePath: resolve(
      appRoot,
      'upstream-overrides',
      'ui-settings-general',
      'ActivityIslandRegistration.tsx.fragment',
    ),
    targetPath: resolve(
      upstreamRoot,
      'packages',
  ...
  {
    name: 'activity-island-settings-locale-zh',
    sourcePath: resolve(
      appRoot,
      'upstream-overrides',
      'ui-settings-general',
      'ActivityIslandLocaleZh.fragment',
    ),
    targetPath: resolve(
      upstreamRoot,
      'packages',
  ...
  {
    name: 'activity-island-settings-locale-en',
    sourcePath: resolve(
      appRoot,
      'upstream-overrides',
      'ui-settings-general',
      'ActivityIslandLocaleEn.fragment',
    ),
    targetPath: resolve(
      upstreamRoot,
      'packages',
...
const testContractReplacements = [
  ...
  },
  {
    ...
    expect(before.slots.entries('settings.section').map(item => item.options.id)).toEqual(['general', 'activity-island', 'about'])`,
  },
  {
    name: 'settings-test-list-seat-count',
    targetPath: resolve(upstreamRoot, 'packages', 'client', 'ui-settings-general', 'tests', 'apply.client.spec.ts'),
    before: '      expect(after.slots.entries(name)).toHaveLength(1)',
    after: "      expect(after.slots.entries(name)).toHaveLength(name === 'settings.section' ? 3 : 1)",
  },
  {
    name: 'settings-test-live-list-seat-count',
    targetPath: resolve(upstreamRoot, 'packages', 'client', 'ui-settings-general', 'tests', 'apply.client.spec.ts'),
    before: '      expect(b.slots.entries(name)).toHaveLength(1)',
    after: "      expect(b.slots.entries(name)).toHaveLength(name === 'settings.section' ? 3 : 1)",
  },
  {
  ...
  },
  {
    ...
    const ACTIVITY_ISLAND = { id: 'activity-island', order: 40, label: 'island.nav' }
    const ABOUT = { id: 'about', order: 1000, label: 'about.nav' }
    expect(sections.getSnapshot()).toEqual([GENERAL, ACTIVITY_ISLAND, ABOUT])`,
  },
  {
